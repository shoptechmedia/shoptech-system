{*
	...
	*}
	...
	<div class="search_block_top mh-search-module">
		<form method="get" action="{$link->getPageLink('search', true, null, null, false, null, true)|escape:'html':'UTF-8'}">
			...
			<div class="search_query_container {if isset($blockCategTree)}search-w-selector{/if}">
				...
				<input class="search_query form-control" type="text"  name="search_query" placeholder="{l s='Search' mod='blocksearch_mod'}" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
			</div>
