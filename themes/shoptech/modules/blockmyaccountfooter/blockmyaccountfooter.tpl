...
<section class="footer-block col-xs-12 col-sm-3">
	...
	<div class="block_content toggle-footer">
		<ul class="bullet">
			...
			<li><a href="{$link->getPageLink('order-slip', true)|escape:'html':'UTF-8'}" title="{l s='My credit slips' mod='blockmyaccountfooter'}">{l s='My credit slips' mod='blockmyaccountfooter'}</a></li>
			...
			<!--{if $voucherAllowed}<li><a href="{$link->getPageLink('discount', true)|escape:'html':'UTF-8'}" title="{l s='My vouchers' mod='blockmyaccountfooter'}">{l s='My vouchers' mod='blockmyaccountfooter'}</a></li>{/if}-->
