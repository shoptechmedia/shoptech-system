							...
							<div class="price">
								<p class="our_price_display" itemprop="offers" itemscope itemtype="https://schema.org/Offer">{strip}
									...
									{if $priceDisplay >= 0 && $priceDisplay <= 2}
										{capture assign="priceForSnippet"}{convertPrice price=$productPrice|floatval}{/capture} 
										<span id="our_price_display" class="price" itemprop="price" content="{$priceForSnippet|regex_replace:'/[^0-9,.]+/':''|replace:',':'.'}">{convertPrice price=$productPrice|floatval}</span>
