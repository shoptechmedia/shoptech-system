                ...
                <div class="col-xs-12 col-md-3">
                    <div class="row">
                        <div class="col-xs-5 form-group">
                            ...
                            <input class="form-control grey" type="text" id="firstname" name="firstname" value="{$customerThread.email|escape:'html':'UTF-8'}" {if isset($customerThread.email)}readonly="readonly"{/if} />
                        </div>

                        <div class="col-xs-6 form-group">
                            <label for="lastname">{l s='Last Name'}</label>

                            <input class="form-control grey" type="text" id="lastname" name="lastname" value="{$customerThread.email|escape:'html':'UTF-8'}" {if isset($customerThread.email)}readonly="readonly"{/if} />
                        </div>
                    </div>
