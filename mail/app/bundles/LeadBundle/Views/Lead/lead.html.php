...
$view['slots']->set(
    'headerTitle',
    $avatar.'<div class="pull-left mt-5"><span class="span-block">'.$view->escape($getFields['firstname']).' '.$view->escape($getFields['lastname']).'</span><span class="span-block small ml-sm">'
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mb-0">
            ...
            <?php endif; ?>
                ...
                <p class="text-muted"><?php echo $view->escape($getFields['email']); ?></p>
