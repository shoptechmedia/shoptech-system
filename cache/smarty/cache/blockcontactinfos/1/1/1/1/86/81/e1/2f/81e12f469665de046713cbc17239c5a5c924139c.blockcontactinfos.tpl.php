...
function content_5ea00ad2df0ff4_18384038 (Smarty_Internal_Template $_smarty_tpl) {
?>
        ...
        <ul class="toggle-footer">
            <li>
                Your Company
                        	...
                        	<li>
            		<i class="icon-map-marker"></i>42 Bee Lane<br />
12345 The Hive<br />
the Netherlands
            	</li>
                                    	<li>
