<?php
/* Smarty version 3.1.31, created on 2020-04-22 16:32:25
  from "/home/shoptech/public_html/beta/login888/themes/shoptech/template/controllers/newsletter/form.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5ea047697132f3_91751302',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ba9c7c024e25a27c176396650e3fca8d5ae69dba' => 
    array (
      0 => '/home/shoptech/public_html/beta/login888/themes/shoptech/template/controllers/newsletter/form.tpl',
      1 => 1585579593,
      2 => 'file',
    ),
  ),
...
function content_5ea047697132f3_91751302 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
>
            ...
            <div class="panel panel-default" id="customize-slot-panel">
                ...
                <div class="panel-body" id="customize-form-container">
                    ...
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="text">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="image">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="imagecard">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="imagecaption">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="button">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="socialfollow">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="codemode">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="separator">
...
>
                    <?php echo '<script'; ?>
 type="text/html" data-slot-type-form="dynamicContent">
...
>
            ...
            <div class="panel panel-default" id="section">
                ...
                <div class="panel-body" id="customize-form-container">
                    ...
                    <?php echo '<script'; ?>
 type="text/html" data-section-form="">
