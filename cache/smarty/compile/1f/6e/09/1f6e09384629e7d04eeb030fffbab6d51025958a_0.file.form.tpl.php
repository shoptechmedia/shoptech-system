<?php
/* Smarty version 3.1.31, created on 2020-04-21 12:31:44
  from "/home/shoptech/public_html/beta/login888/themes/shoptech/template/controllers/cart_rules/form.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e9ebd803a70c0_50706319',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1f6e09384629e7d04eeb030fffbab6d51025958a' => 
    array (
      0 => '/home/shoptech/public_html/beta/login888/themes/shoptech/template/controllers/cart_rules/form.tpl',
      1 => 1587461502,
      2 => 'file',
    ),
  ),
...
function content_5e9ebd803a70c0_50706319 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="panel">
	<div class="card-header">
		<i class="icon-tag"></i>
		<h3 class="card-title"><?php echo smartyTranslate(array('s'=>'Cart rule'),$_smarty_tpl);?>
</h3>
	</div>

	<div class="card-body">
		<ul class="tab nav nav-tabs">
			<li class="tab-row mr-1">
				<a class="btn btn-default tab-page" id="cart_rule_link_informations" href="javascript:displayCartRuleTab('informations');"><i class="icon-info"></i> <?php echo smartyTranslate(array('s'=>'Information'),$_smarty_tpl);?>
</a>
			</li>
			<li class="tab-row mr-1">
				<a class="btn btn-default tab-page" id="cart_rule_link_conditions" href="javascript:displayCartRuleTab('conditions');"><i class="icon-random"></i> <?php echo smartyTranslate(array('s'=>'Conditions'),$_smarty_tpl);?>
</a>
			</li>
			<li class="tab-row mr-1">
				<a class="btn btn-default tab-page" id="cart_rule_link_actions" href="javascript:displayCartRuleTab('actions');"><i class="icon-wrench"></i> <?php echo smartyTranslate(array('s'=>'Actions'),$_smarty_tpl);?>
</a>
			</li>
		</ul>
	</div>
...
&amp;addcart_rule" id="cart_rule_form" class="form-horizontal card-body" method="post">
