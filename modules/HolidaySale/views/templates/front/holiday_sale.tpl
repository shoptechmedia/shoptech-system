...
{include file="$tpl_dir2/product-list.tpl" products=$products marker=$holiday->banner_image marker_font_color=$holiday->banner_image_font_color}
{/if}
