...
{   
    ...
    public function prepareModuleSettings()
    {
        ...
        **/
        Configuration::updateGlobalValue('PH_BLOG_LOAD_FONT_AWESOME', 0);
        Configuration::updateGlobalValue('PH_BLOG_LOAD_BXSLIDER', 0);
        Configuration::updateGlobalValue('PH_BLOG_LOAD_MASONRY', 0);
    ...
    public function uninstall()
    {
        ...
        **/
        Configuration::deleteByName('PH_BLOG_LOAD_FONT_AWESOME', 0);
