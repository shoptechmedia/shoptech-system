    ...
    <td colspan="2" id="cart_voucher" class="cart_voucher">
        {if $voucherAllowed}
            ...
            <form action="{if $opc}{$link->getPageLink('order-opc.php', true)|escape:'htmlall':'UTF-8'}{else}{$link->getPageLink('order.php', true)|escape:'htmlall':'UTF-8'}{/if}"
                ...
                <fieldset>
                    <h4><label for="discount_name" style="
    margin-top: 5px;">{l s='Vouchers' mod='onepagecheckout'}</label></h4>
...
{if $use_taxes}
    {if $priceDisplay}
        <tr class="cart_total_products summary-line">
            <td>{if $display_tax_label}{l s='Total products (tax excl.):' mod='onepagecheckout'}{else}{l s='Total products:' mod='onepagecheckout'}{/if}</td>
            <td class="price" id="total_product">{displayPrice price=$total_products}</td>
        </tr>
    {else}
        <tr class="cart_total_products summary-line">
            <td >{if $display_tax_label}{l s='Total products (tax incl.):' mod='onepagecheckout'}{else}{l s='Total products:' mod='onepagecheckout'}{/if}</td>
            <td class="price" id="total_product">{displayPrice price=$total_products_wt}</td>
        </tr>
    {/if}
{else}
    <tr class="cart_total_products summary-line">
        <td >{l s='Total products:' mod='onepagecheckout'}</td>
        <td class="price" id="total_product">{displayPrice price=$total_products}</td>
    </tr>
{/if}
...
{if $total_shipping_tax_exc <= 0 && !isset($virtualCart)}
    <tr class="cart_total_delivery summary-line">
        <td >{l s='Shipping:' mod='onepagecheckout'}</td>
    ...
    {if $use_taxes}
        {if $priceDisplay}
            <tr class="cart_total_delivery summary-line" {if $total_shipping_tax_exc <= 0} style="display:none;"{/if}>
                <td >{if $display_tax_label}{l s='Total shipping (tax excl.):' mod='onepagecheckout'}{else}{l s='Total shipping:' mod='onepagecheckout'}{/if}</td>
        ...
        {else}
            <tr class="cart_total_delivery summary-line"{if $total_shipping <= 0} style="display:none;"{/if}>
                <td >{if $display_tax_label}{l s='Total shipping (tax incl.):' mod='onepagecheckout'}{else}{l s='Total shipping:' mod='onepagecheckout'}{/if}</td>
                <td class="price" id="total_shipping">{displayPrice price=$total_shipping}</td>
            </tr>
        {/if}
    {else}
        <tr class="cart_total_delivery summary-line"{if $total_shipping_tax_exc <= 0} style="display:none;"{/if}>
            <td >{l s='Total shipping:' mod='onepagecheckout'}</td>
            <td class="price" id="total_shipping">{displayPrice price=$total_shipping_tax_exc}</td>
        </tr>
    {/if}
{/if}
{if $use_taxes}
    <tr class="cart_tax_exc_price summary-line">
        <td >{l s='Total (tax excl.):' mod='onepagecheckout'}</td>
    ...
    <tr class="cart_total_tax summary-line">
        <td >{l s='Total tax:' mod='onepagecheckout'}</td>
