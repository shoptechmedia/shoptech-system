...
<fieldset>
    <h3>
        <div class="image-number"><div class="image-number-container"><div class="image-number-actual">4</div></div></div>
        {l s='Choose your payment method' mod='onepagecheckout'}
    </h3>
...
<div class="std" id="cart_section">
    <h3 id="cart_title opc-title">
<div class="image-number"><div class="image-number-container"><div class="image-number-actual">5</div></div></div>KURV</h3>
    ...
    {if !$opc_config.order_detail_review}
        ...
        <p class="checkbox" style="float:right">
            <input type="checkbox" name="cgv" id="cgv" value="1" {if $checkedTOS}checked="checked"{/if} />
            <label for="cgv">{l s='Jeg accepterer hermed betingelserne' mod='onepagecheckout'}</label>
    ...
    <form class="std{if isset($opc_config.hide_password_box) && $opc_config.hide_password_box} no_show{/if}" action="javascript:return false;" id="offer_password" style="display: none;">
        <fieldset>
            {if !isset($opc_config.offer_password_top) || !$opc_config.offer_password_top}{$smarty.capture.password_checkbox}{/if}
    {if !isset($opc_config.offer_password_top) || !$opc_config.offer_password_top}{$smarty.capture.password_field}{/if}
        </fieldset>
