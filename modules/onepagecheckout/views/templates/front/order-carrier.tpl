      ...
      {if !$displayForm}style="display:none"{/if}>
        ...
        {if !isset($isVirtualCart) || !$isVirtualCart}
            <h3 id="choose_delivery"
                {if $singleCarrier}style="display:none;"{/if}>
<div class="image-number"><div class="image-number-container"><div class="image-number-actual">3</div></div></div>
                {l s='Choose your delivery method' mod='onepagecheckout'}</h3>
        {/if}
    <fieldset>

        <div id="opc_delivery_methods" class="opc-main-block">
            {*<div id="selected_shop_error"></div>*}
