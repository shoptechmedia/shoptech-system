...
{capture name=account_block}
   ...
   <div class="account_fields">
    ...
    <p style="margin-top:5px !important;" class="checkbox" {if !isset($opc_config.newsletter) || !$opc_config.newsletter}style="display: none;"{/if}>
...
{capture name=delivery_address_block}
    ...
    <fieldset id="opc_delivery_address" style="display: {if (isset($guestInformations) && $guestInformations.use_another_invoice_address) OR (!isset($guestInformations) && $def_different_billing == 1) OR !$invoice_first}block{else}none{/if}">
        <h3>
<div class="image-number"><div class="image-number-container"><div class="image-number-actual">2</div></div></div>
...
{capture name='login_block'}
    <form action="{$link->getPageLink('authentication.php', true)|escape:'htmlall':'UTF-8'}?back=order-opc.php" method="post" id="login_form"
        ...
        <fieldset>
            <h3><div id="closeLoginFormContainer"><img src="{$modules_dir|escape:'html':'UTF-8'}onepagecheckout/views/img/close_icon.png" id="closeLoginFormBlock" /></div>{l s='Already registered?' mod='onepagecheckout'} <a href="#" id="openLoginFormBlock">{l s='Log-in' mod='onepagecheckout'}</a>
            </h3>
...
<div class="image-number"><div class="image-number-container"><div class="image-number-actual">1</div></div></div>
<form action="{$link->getPageLink('authentication.php', true)|escape:'htmlall':'UTF-8'}?back=order-opc.php" method="post" id="login_form"
          class="std" {if ($isLogged && !$isGuest)}style="display:none;"{/if}>
    <fieldset>
        <h3><div id="closeLoginFormContainer"><img src="{$modules_dir|escape:'html':'UTF-8'}onepagecheckout/views/img/close_icon.png" id="closeLoginFormBlock" /></div>{l s='Already registered?' mod='onepagecheckout'} <a href="#" id="openLoginFormBlock">{l s='Log-in' mod='onepagecheckout'}</a>
...
<div id="voucher_toggle_wrap">
    <a href="#" id="voucher_toggle">{l s='Do you have a discount code - click here' mod='onepagecheckout'}</a>
</div>
