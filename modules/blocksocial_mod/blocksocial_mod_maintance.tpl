<link href="{$module_template_dir}blocksocial_mod.css" rel="stylesheet" type="text/css" />
<section id="social_block_mod" class="social_block_mod title_block col-xs-12 col-ms-6">
