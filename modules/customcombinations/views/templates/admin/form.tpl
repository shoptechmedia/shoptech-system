	...
	<div class="panel-body">
		{foreach $pages as $page}
			...
			<div class="holiday_item row">
				...
				<span class="col-xs-3">
					<a target="_blank" href="/holiday_sale/{$page.id_holiday_sale}-{$page.link_rewrite}">View</a> | 
					<a href="#" class="edit_holiday_page" data-id_holiday_sale="{$page.id_holiday_sale}">Edit</a> | 
					<a href="#" class="delete_holiday_page" data-id_holiday_sale="{$page.id_holiday_sale}">Delete</a>
				</span>
			</div>
			{/if}
		{/foreach}
