...
{if isset($news)}
    ...
    {/if}
    <div id="prestablogfont2">{PrestaBlogContent return=$news->content2}</div>
...
<div class="block_bas">
                    ...
                    {if isset($article.link)}
                            <a href="{$article.link|escape:'htmlall':'UTF-8'}" class="blog_link">{l s='Read more' mod='prestablog'}</a>{/if}
                </div>
</div>
</li>
