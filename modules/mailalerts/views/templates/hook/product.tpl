...
<!-- MODULE MailAlerts -->
	{if isset($email) AND $email}
		<input style="margin-top:10px;" type="text" id="oos_customer_email" name="customer_email" size="20" value="{l s='your@email.com' mod='mailalerts'}" class="mailalerts_oos_email" onclick="clearText();" /><br />
	{/if}
