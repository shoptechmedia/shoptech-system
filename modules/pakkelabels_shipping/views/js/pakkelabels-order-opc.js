...
function checkdroppointselected(eventElement){
	 // Show buy button
	jQuery('#hidden_choosen_shop').val(jQuery(eventElement).attr('data-shopid'));
	jQuery('#HOOK_PAYMENT_DISABLED').hide();
        ...
        if (key == event['context'].getAttribute('data-shopid'))
        {
         ...
         //       jQuery('#selected_shop_context').append( jQuery(this).get(0).outerHTML);
           // })
            ...
            jQuery('#hidden_choosen_shop').val(event['context'].getAttribute('data-shopid'));
            //adds the shop information to the #selected_shop div
            jQuery('#selected_shop_header').html(selected_shop_header);
...
jQuery(window).on('load', function() { //jQuery(document).ready(function () {
    ...
    if(iPakkelabels_ID_WINDOW=='Popup') {
        var sZipcodeHTMLtr = '<tr><td><div class="pakkelabels_shipping_field-wrap" id="pakkelabels-zipcode-wrapper"> <div class="pakkelabels_shipping_field"> <div class="pakkelabels-clearfix" id="pakkelabels_shipping_button"> <div class="pakkelabels_stores"> <div> <input type="text" id="Pakkelabels_zipcode_field" name="pakkelabels_zipcode" class="input" placeholder="'+sPakkelabels_zipcode_field+'"> </div> <div> <input type="button" id="pakkelabels_find_shop_btn" name="pakkelabel_find_shop" class="button button-small btn btn-default" value="'+ sPakkelabels_find_shop_btn_text +'"> </div> </div> </div> <input type="hidden" id="hidden_choosen_shop" /><div class="pakkelabels-clearfix" id="selected_shop_wrapper"> <div class="pakkelabels-clearfix" id="selected_shop_header">'+ sSelected_shop_header +'</div> <div class="pakkelabels-clearfix" id="selected_shop_context"> </div> </div> </div> </div></td></tr>';
    } else {
         var sZipcodeHTMLtr = '<tr><td><div class="pakkelabels_shipping_field-wrap" id="pakkelabels-zipcode-wrapper"> <div class="pakkelabels_shipping_field"> <div class="pakkelabels-clearfix" id="pakkelabels_shipping_button"> <div class="pakkelabels_stores"> <div> <input type="text" id="Pakkelabels_zipcode_field" name="pakkelabels_zipcode" class="input" placeholder="'+sPakkelabels_zipcode_field+'"> </div> <div class="pakkelabels-shoplist dropdown"> <button class="btn btn-primary dropdown-toggle" id="pakkelabels_find_shop_btn" type="button" data-toggle="dropdown">' + sPakkelabels_find_shop_btn_text + '<span class="caret"></span></button></div> </div> </div> <input type="hidden" id="hidden_choosen_shop" /><div class="pakkelabels-clearfix" id="selected_shop_wrapper"> <div class="pakkelabels-clearfix" id="selected_shop_header">'+ sSelected_shop_header +'</div> <div class="pakkelabels-clearfix" id="selected_shop_context"> </div> </div> </div> </div></td></tr>';
    }
    ...
    jQuery('#opc_payment_methods-content').append('<div id="HOOK_PAYMENT_DISABLED" style="display:none;"><div class="col-xs-12"><p class="warning">'+sPakkelabel_modal_header_h4+'</p></div></div>');
	...
	if (checked_shipping) {
		...
		if(checked_shipping == iPakkelabels_ID_GLS || checked_shipping == iPakkelabels_ID_POSTNORD || checked_shipping == iPakkelabels_ID_DAO || checked_shipping == iPakkelabels_ID_BRING) {        
			...
			jQuery("#HOOK_PAYMENT_DISABLED").show();
			...
			if (defaultZipcode) {
				...
				if (typeof formatedAddressFieldsValuesList === 'undefined' || formatedAddressFieldsValuesList== null) {
					...
					var id_delivery = jQuery('#id_address_delivery').val();
    ...
    jQuery( document ).ajaxComplete(function( event, xhr, settings ) { 	        	
    	...
    	if (checked_shipping) {
	        ...
	        if( checked_shipping == iPakkelabels_ID_GLS || checked_shipping == iPakkelabels_ID_DAO || checked_shipping == iPakkelabels_ID_POSTNORD || checked_shipping == iPakkelabels_ID_BRING ) {
	        	...
	        	if (checked_shipping != selectedCarrier || jQuery('#pakkelabels-zipcode-wrapper').length < 1)  {
