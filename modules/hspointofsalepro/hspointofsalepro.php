...
if (!defined('_ROCKPOS_VERSION_')) {
    ...
    define('_ROCKPOS_VERSION_', '4.1.12'); // this needs to go ahead of HsAutoload.
}
...
spl_autoload_register(array(
    HsAutoload::getSingleton(
        basename(__FILE__, '.php') . '_' . md5(realpath(__FILE__)),
        _ROCKPOS_VERSION_,
        _ROCKPOS_DIR_,
        array('classes/', 'pdf/', 'components/')
    ),
    'load'
));
...
class HsPointOfSalePro extends PosPaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->author_address = '0x3a4e5F8B99160fEbfae1CBC928e4D318947FBefA';
        parent::__construct();
        ...
        PosInstaller::installCarrier($this);
    }
    ...
    protected function initTranslations()
    {
        ...
        $this->i18n = array(
            ...
            'access_denied' => $this->l('Access denied.', $source),
            ...
            'add_missing_customers_to_the_index' => $this->l('Add missing customers to the index', $source),
            ...
            'print_automatically' => $this->l('Print automatically', $source),
            'print_automatically_quantity' => $this->l('Print automatically quantity', $source),
            'disable_this_option_if_you_dont_want_to_print_automatically' => $this->l('Disable this option if you dont want to print automatically', $source),
            'amount' => $this->l('Amount', $source),
            'amount_due' => $this->l('Amount due', $source),
            'amount_tendered' => $this->l('Amount tendered', $source),
            'an_error_occurred_during_the_image_move_process' => $this->l(
                'an error occurred during the image move process',
                $source
            ),
            'an_error_occurred_during_the_image_resize_process' => $this->l(
                'an error occurred during the image resize process',
                $source
            ),
            'an_error_occurred_during_the_image_upload_process' => $this->l(
                'an error occurred during the image upload process',
                $source
            ),
            'an_error_occurred_while_attempting_to_change_your_password' => $this->l(
                'An error occurred while attempting to change your password.',
                $source
            ),
            'an_internal_error_occurred_during_loading_the_previous_orders' => $this->l(
                'an internal error occurred during loading the previous orders',
                $source
            ),
            ...
            'are_you_sure_to_undo_this_payment_record' => $this->l(
                'Are you sure to undo this payment record?',
                $source
            ),
            'are_you_sure_you_will_proceed_without_adding_a_customer' => $this->l(
                'Are you sure you will proceed without adding a customer?',
                $source
            ),
            ...
            'change_product_price' => $this->l('Change product price', $source),
            ...
            'choose_this_option_if_you' => $this->l('Choose this option if you:', $source),
            'choose_this_option_if_you_print_in_english_and_currency_is_dollar' => $this->l(
                'Choose this option if you print in English and currency is $.',
                $source
            ),
            'city' => $this->l('City', $source),
            'click_continue_to_proceed_with_setting_up' => $this->l(
                'Click "Continue" to proceed with setting up.',
                $source
            ),
            'click_here' => $this->l('Click Here', $source),
            'click_here_to_enable_friendly_url_first' => $this->l(
                'Click here to enable "Friendly URL" first.',
                $source
            ),
            ...
            'commissions_report' => $this->l('Commissions report', $source),
            ...
            'do_you_want_to_cancel_this_exchange_transaction' => $this->l(
                'Do you want to cancel this exchange transaction?',
                $source
            ),
            'do_you_want_to_cancel_this_order' => $this->l('Do you want to cancel this order?', $source),
            'do_you_want_to_cancel_this_return_transaction' => $this->l(
                'Do you want to cancel this return transaction?',
                $source
            ),
            ...
            'enter_product_name_reference_ean13_upc_etc' => $this->l(
                'Enter product name, reference, EAN-13 , UPC, etc...',
                $source
            ),
            'everywhere' => $this->l('Everywhere', $source),
            'exchange' => $this->l('Exchange', $source),
            'exchange_slip' => $this->l('Exchange slip', $source),
            'exclTax' => $this->l('Excl.tax', $source),
            'exempt_of_vat_according_to_section_259b_of_the_general_tax_code' => $this->l(
                'Exempt of VAT according to section 259B of the General Tax Code.',
                $source
            ),
            'export_to_excel' => $this->l('Export to Excel', $source),
            'export_to_pdf' => $this->l('Export to PDF', $source),
            'images_on_search_bar' => $this->l('Images on search bar', $source),
            'scan_barcode_or_type_to_search' => $this->l('Scan barcode or type to search', $source),
            'salesperson_not_found' => $this->l('Sales person not found', $source),
            'fax' => $this->l('Fax', $source),
            'feature' => $this->l('Feature', $source),
            'features' => $this->l('Features', $source),
            'in_out' => $this->l('In/Out', $source),
            'filter' => $this->l('Filter', $source),
            'filter_fields' => $this->l('Filter fields', $source),
            ...
            'give_discount' => $this->l('Give discount', $source),
            ...
            'id' => $this->l('ID', $source),
            'idOrder' => $this->l('Order ID', $source),
            'if_no_logo_uploaded_the_shop_logo_will_be_used_instead' => $this->l(
                'If no logo uploaded, the shop logo will be used instead.',
                $source
            ),
            'if_you_are_a_premium_user_use_the_email_associated_with_your_purchase' => $this->l(
                'If you are a Premium user, use the email associated with your purchase.',
                $source
            ),
            'image' => $this->l('Image', $source),
            'images_in_shopping_cart' => $this->l('Images in shopping cart', $source),
            'inactive' => $this->l('Inactive', $source),
            'inclTax' => $this->l('Incl.tax', $source),
            'indexing_status' => $this->l('Indexing status', $source),
            'indicates_a_required_field' => $this->l('Indicates a required field', $source),
            'install_it_as_a_typical_program_on_your_pc' => $this->l(
            ...
            'invalid_search_sound' => $this->l('"Invalid search" sound', $source),
            ...
            'just_enable_this_option_in_case_you_cant_print_special_characters' => $this->l(
                'Just enable this option in case you can\'t print special character(s)',
                $source
            ),
            ...
            'max_fields_chosen' => $this->l('Max fields chosen', $source),
            ...
            'need_to_print_special_characters' => $this->l('Need to print special characters', $source),
            ...
            'oops_your_lite_free_version_exceeds_to_xx_orders_in_last_30_days' => $this->l(
                'Oops, your LITE (free) version exceeds to [xx] orders in last 30 days.',
                $source
            ),
            'oops_your_session_just_expired' => $this->l(
                'Oops, your session just expired. Please log in again!',
                $source
            ),
            'or' => $this->l('or', $source),
            ...
            'order_completed_but_some_external_processes_are_not_done_as_expected' => $this->l(
                'Order completed, but some external processes are not done as expected.',
                $source
            ),
            ...
            'original_price' => $this->l('Original price', $source),
            'other' => $this->l('Other', $source),
            'others' => $this->l('Others', $source),
            'otherwise_enter_your_most_used_email_to_go_with_lite_free_version' => $this->l(
                'Otherwise, enter your most used email to go with LITE (free) version.',
                $source
            ),
            ...
            'pdf' => $this->l('PDF', $source),
            'permissions' => $this->l('Permissions', $source),
            'phone' => $this->l('Phone', $source),
            'pick_up_in_store' => $this->l('Pick up in-store', $source),
            'pick_up_one' => $this->l('Pick Up One', $source),
            'please_activate_your_license_by_entering_your_email' => $this->l(
                'Please activate your license by entering your email',
                $source
            ),
            'please_configure_the_default_printer_setting_in_step_2_first' => $this->l(
                'Please configure the default printer settings in step 2 first.',
                $source
            ),
            'please_enable' => $this->l('please enable', $source),
            'please_enter_email_or_firstname' => $this->l('Please enter email or firstname.', $source),
            'please_enter_your_email_address_you_will_receive_a_link_to_create_a_new_password_via_email' => $this->l(
                'Please enter your email address. You will receive a link to create a new password via email.',
                $source
            ),
            'please_fill_the_required_custom_fields_to_complete_the_sale' => $this->l(
                'Please fill the required custom fields to complete the sale',
                $source
            ),
            'please_install' => $this->l('please install', $source),
            'please_mark_another_payment_as_default_instead' => $this->l(
                'Please mark another payment as default instead.',
                $source
            ),
            ...
            'price_tax_incl' => $this->l('Price (tax incl)', $source),
            ...
            'print_method' => $this->l('Print method', $source),
            ...
            'products_are_indexed_automatically_whenever_they_are_added_or_edited' => $this->l(
                'Products are indexed automatically whenever they are added or edited',
                $source
            ),
            ...
            'rockpos_utilizes_qz_tray_to_print_your_receipt' => $this->l(
                'RockPOS utilizes QZ tray to print your receipt.',
                $source
            ),
            ...
            'stock_qty_available' => $this->l('( Stock: %s )', $source),
            ...
            'the_order_cannot_be_found_within_your_database' => $this->l(
                'The order cannot be found within your database.',
                $source
            ),
            'the_order_slip_cannot_be_found_within_your_database' => $this->l(
                'The order slip cannot be found within your database.',
                $source
            ),
            ...
            'there_was_an_error_saving_this_product' => $this->l(
                'There was an error saving this product. Please try again!',
                $source
            ),
            'this_account_does_not_exist' => $this->l('This account does not exist.', $source),
            'this_employee_does_not_manage_the_shop_anymore' => $this->l(
            ...
            'this_variant_already_exists_in_your_order' => $this->l(
                'This variant already exists in your order.',
                $source
            ),
            ...
            'to_pre_load_products_under_these_categories' => $this->l(
                'To pre-load products under these categories',
                $source
            ),
            'to_solve_it_just_simply_go_with_premium_plan_which_costs_only_a_cup_of_coffee_a_day' => $this->l(
                'To solve it, just simply go with Premium plan which costs only a cup of coffee a day.',
                $source
            ),
            ...
            'total_real_paid_after_refund' => $this->l('Total (real paid - After refund)', $source),
            'total_shipping' => $this->l('Total shipping', $source),
            'total_tax' => $this->l('Total tax', $source),
            'product_note' => $this->l('Product note', $source),
            ...
            'total_shipping_tax' => $this->l('Total shipping tax', $source),
            'in' => $this->l('In', $source),
            'out' => $this->l('Out', $source),
            'transactions' => $this->l('Transactions', $source),
            'transform_to_a_voucher_and_apply_to_this_order' => $this->l(
                'Transform to a voucher and apply to this order',
                $source
            ),
            ...
            'use_apple_os_lion_or_lower' => $this->l('Use Apple OS (v.10.7 Lion or lower)', $source),
            ...
            'warn_cashiers_if_they_are_about_to_make_guest_checkout' => $this->l(
                'Warn cashiers if they are about to make a guest checkout.',
                $source
            ),
            'we_cannot_establish_a_connection_to_qz_tray' => $this->l(
                'We cannot establish a connection to QZ tray.',
                $source
            ),
            'we_dont_want_your_business_affected_by_this_limitation' => $this->l(
                'We dont want your business affected by this limitation.',
                $source
            ),
            'we_would_like_to_serve_you_better_and_we_are_looking_for_anonymous_data_to_improve_rockpos_day_by_day' => $this->l(
                'We would like to serve you better, and we are looking for anonymous data to improve RockPOS day by day.',
                $source
            ),
            ...
            'whoops_it_seems_qz_tray_has_not_launched_properly_yet' => $this->l(
                'Whoops, it seems QZ tray has not launched properly yet.',
                $source
            ),
            ...
            'you_can_regenerate_your_password_only_every_minutes' => $this->l(
                'You can regenerate your password only every %s minutes',
                $source
            ),
            'you_can_set_a_cron_job_that_will_build_your_index_using_the_following_url' => $this->l(
                'You can set a cron job that will build your index using the following URL:',
                $source
            ),
            'you_cannot_apply_loyalty_points_on_these_products' => $this->l(
                'You cannot apply loyalty points on these products.',
                $source
            ),
            'you_cannot_use_this_voucher_with_these_products' => $this->l(
                'You cannot use this voucher with these products',
                $source
            ),
            'you_cant_access_to_this_shop_at_front_office' => $this->l(
                "you can't access to this shop at front office",
                $source
            ),
            'you_dont_have_permission_to_access_this_area' => $this->l(
                'You don\'t have permission to access this area.',
                $source
            ),
            'you_have_made_of_orders_in_last_30_days' => $this->l(
                'You have made [totalOrder] of [limitOrder] orders in last 30 days.',
                $source
            ),
            'you_must_enter_a_voucher_code' => $this->l('You must enter a voucher code.', $source),
            'you_saved' => $this->l('You saved', $source),
            'you_will_be_redirected_automatically_in_span_3_span_seconds_or_click_a_here_a' => $this->l(
                'You will be redirected automatically in [span] 3 [/span] seconds, or click [a]here[/a].',
                $source
            ),
            'your_account_does_not_exist_or_the_password_is_incorrect' => $this->l(
                'Your account does not exist or the password is incorrect.',
                $source
            ),
            ...
            'your_license_has_expired' => $this->l(
                'Your license has expired. Please renew your license. In case you forgot to renew your license, you still can use your RockPOS as Starter version.',
                $source
            ),
            ...
            'print_gift_receipt' => $this->l('Print gift receipt', $source),
            'change_returned' => $this->l('Change returned', $source),
            'amount_received' => $this->l('Amount received', $source),
            'online_carts' => $this->l('Online carts', $source),
            'show_currency' => $this->l('Show currency', $source),
            'disable_this_option_if_you_dont_want_to_show_currency_symbol_next_to_product_price' => $this->l(
                "Disable this option if you don't want to show currency symbol next to product price",
                $source
            ),
            'you_have_days_trial' => $this->l('You have [days] days trial.', $source),
            'product_is_out_of_stock' => $this->l('Product is out of stock. You can not change order state', $source),
            'refund' => $this->l('Refund', $source),
            'receipt_format' => $this->l('Receipt format', $source),
            'pre_order' => $this->l('Pre-order', $source),
            'unpaid' => $this->l('Unpaid', $source),
            'done' => $this->l('Done', $source),
            'enable_to_setup_peronalised_receipt_format_as_per_staff' => $this->l(
                'Enable to setup the personalised receipt format as per staff',
                $source
            ),
            'id_cart' => $this->l('ID Cart', $source),
            'an_account_using_this_barcode_has_already_been_registered' => $this->l(
                'An account using this barcode has already been registered.',
                $source
            ),
            'close_popup_after_print' => $this->l("Close the popup 'ORDER COMPLETED' after printing receipts", $source),
            "out_of_stock" => $this->l("Out of stock paid", $source),
            "out_of_stock_unpaid" => $this->l("Out of stock unpaid", $source),
            "please_fill_all_the_fields" => $this->l("Please fill all the fields", $source),
            "products_out_of_stock" => $this->l("Out-of-stock items removed from cart", $source),
            "due_amount_customer" => $this->l("Due amount", $source),
            "no_name_method" => $this->l("No name payment", $source),
    ...
    public function install()
    {
        ...
        copy(_ROCKPOS_DIR_ . '/override/classes/Cart.php', '../override/classes/Cart.php');
     ...
     *                      )</pre>
     */
    public function hookActionCustomerSave(array $params)
    {

        if (Validate::isLoadedObject($params['customer'])) {
            $pos_search_index = new PosCustomerSearchIndex(false, false, (int)$params['customer']->id);
            $pos_search_index->run();
        }
     ...
     *                      )</pre>
     */
    public function hookActionCustomerDelete(array $params)
    {
            if (Validate::isLoadedObject($params['customer'])) {
                $pos_search_index = new PosCustomerSearchIndex(false, true, (int)$params['customer']->id);
                $pos_search_index->run();
            }
    }
    ...
    public function initContext($force = false)
    {
        ...
        // Employee
        $id_employee = defined('_PS_ADMIN_DIR_') ? $this->context->cookie->id_employee : isset($this->context->cookie->pos_id_employee) ? $this->context->cookie->pos_id_employee : 0;
        $employee = new PosEmployee((int)$id_employee);
        if (Validate::isLoadedObject($employee)) {
            $this->context->employee = $employee;
            $this->is_logged = $this->isLoggedSell($employee);
        }
        // Shop
        ...
        if (Validate::isLoadedObject($this->context->customer)) {
            ...
            if ($cart->id_address_delivery == 0 || $cart->id_address_invoice == 0) {
                $cart->id_address_delivery = Address::getFirstCustomerAddressId((int)$cart->id_customer);
                $cart->id_address_invoice = Address::getFirstCustomerAddressId((int)$cart->id_customer);
                $cart->save();
    ...
    /**
     * @param PosEmployee $employee
     *
     * @return bool
     */
    public function isLoggedSell($employee)
    {
        $is_logged = false;
        if (Validate::isLoadedObject($employee)) {
            $id_tab_sell = PosTab::getIdFromClassName('AdminRockPosSales');
            $tab_access = PosProfile::getProfileAccess($employee->id_profile, $id_tab_sell);
            if ($tab_access && is_array($tab_access)) {
                $is_logged = $tab_access['view'] || $tab_access['add'] || $tab_access['edit'] || $tab_access['delete'];
            }
        }
    ...
    protected function createEmptyCart()
    {
        ...
        $default_customer = new Customer(PosCustomer::getDefaultCustomerIds(
    ...
    public function addProductToCart($id_product, $id_product_attribute = 0, $shop = null, $qty = 0)
    {
        ...
        if (!Validate::isLoadedObject($this->context->cart)) {
            ...
            // in some servers there is a mistake when assign pos_id_cart to cookie at init step, so this quick fix to make sure it always assign to cookie
            $this->context->cookie->pos_id_cart = $this->context->cart->id;
            $this->context->cookie->write();
        }
        ...
        if (Validate::isLoadedObject($this->context->cart)) {
            ...
            $quantity = $qty ? $qty : $this->context->cart->getMinimalQuantityToBeAdded(
                $id_product,
    ...
    public function setDefaultCarrier()
    {
        ...
        foreach ($carriers as $carrier) {
            if ($carrier['id_carrier'] === $id_default_carrier && $id_carrier == 0) {
    ...
    public function getProductSearchBy()
    {
        ...
        $product_search = array(
            ...
            array(
                ...
                'label' => $this->i18n['short_description'],
    ...
    public function getDefaultAddress()
    {
        ...
        $default_customer_id = PosCustomer::getDefaultCustomerIds(
            $this->context->cookie->pos_id_employee,
            $this->context->shop->id
        );
...
//                    echo 'fail';
     ...
     *               )
     */
    public function getTaxDetails(PosOrder $order, $valid = null)
    {
        $tax_details = array();
        $taxes = $order->getTaxes($valid === false ? $valid : true);
        $currency = new PosCurrency($order->id_currency);
        if (!empty($taxes)) {
    ...
    public function getProductsTaxDetail(array $products)
    {
        $tax_details = array();
        foreach ($products as $product) {
            foreach ($product['tax_detail'] as $tax) {
                if (isset($tax_details[$tax['id']])) {
                    $tax_details[$tax['id']]['tax_amount'] = Tools::ps_round(isset($product['return']) && $product['return'] ? $tax_details[$tax['id']]['tax_amount'] - $tax['tax_amount'] : $tax_details[$tax['id']]['tax_amount'] + $tax['tax_amount'], PosConstants::POS_PRICE_COMPUTE_PRECISION);
                } else {
                    $tax_details[$tax['id']] = [
                        'name' => $tax['name'],
                        'id' => $tax['id'],
                        'tax_rate' => $tax['tax_rate'],
                        'tax_amount' => isset($product['return']) && $product['return'] ? -$tax['tax_amount'] : $tax['tax_amount']
                    ];
                }
            }
        }
    ...
    {
        $id_employee = $this->getIdEmployeeByPersonalSetting();
        ...
        if (!empty($exchange_products) && empty($return_products)) {
            $products = $exchange_products;
        } elseif (!empty($exchange_products) && !empty($return_products)) {
            $products = array_merge($products, $exchange_products);
        }
        $notes = PosProductNote::getByIdOrder($order->id);
        if ($is_return) {
            $notes_return = PosProductNote::getByIdOrder($order->id + 1);
            foreach ($notes_return as $k => $v) {
                array_push($notes, $v);
            }
        }
        ...
        foreach ($products as &$product) {
            ...
            $note = PosProductNote::findByProductAttribute($notes, $product['product_id'], $product['product_attribute_id'], isset($product['id_customization']) ? $product['id_customization'] : 0);
            ...
            $product['product_unit_price'] = PosProduct::reformattedPrice($unit_price, $currency, $id_employee);
            $product['product_original_price'] = PosProduct::reformattedPrice($original_price, $currency, $id_employee);
            $product['product_price_original'] = $original_price;
            $product['product_total_price'] = PosProduct::reformattedPrice($total_price, $currency, $id_employee);
            $product['product_final_price'] = $unit_price;
            $product['quantity'] = $product['product_quantity'];
            $product['reference'] = $product['product_reference'];
            $product['note_product'] = $note ? $note['note'] : null;
            $product['tax_detail'] = PosTax::getProductTaxDetail($product['tax_calculator'], $product['total_price_tax_excl'], $product['product_quantity'], $this->context->language->id);
            $product['tax_amount'] = Tools::ps_round($product['total_price_tax_incl'] - $product['total_price_tax_excl'], PosConstants::POS_PRICE_COMPUTE_PRECISION);
    ...
    /**
     * @param $order_collections
     * @param array $return_products
     * @param bool $tax_incl
     * @return float|int
     */
    public function getTotalOrderDiscount($order_collections, $return_products = [], $tax_incl = true)
    {
        $total_order_discount = 0;
        $total_order_return = 0;
        $first = !empty($return_products);
        foreach ($return_products as $return_product) {
            $total_order_return += $return_product['total_price_tax_incl'];
        }
            ...
            if (!empty($order_discounts)) {
                foreach ($order_discounts as $discount) {
                    if (empty($discount['gift_product'])) {
                        if ($first) {
                            $total_order_discount += $tax_incl ? (float)$discount['value'] : (float)$discount['value_tax_excl'];
                            $total_order_discount = $total_order_discount * ($total_order_return / ($order->total_paid_tax_incl + $total_order_discount));
                        } else {
                            $total_order_discount += $tax_incl ? (float)$discount['value'] : (float)$discount['value_tax_excl'];
                        }
                    }
     ...
     * @return string
     */
    public function getTotalOrderGiftDiscount($order_collections)
    {
        $total_order_discount = 0;
        foreach ($order_collections as $order) {
            $order_discounts = $order->getCartRules();
            if (!empty($order_discounts)) {
                foreach ($order_discounts as $discount) {
                    if (!empty($discount['gift_product'])) {
                        $total_order_discount += (float)$discount['value_tax_excl'];
                    }
                }
            }
        }
     ...
     * @return string
     */
    public function getTotalProductDiscount(array $products)
    {
        $total_product_discount = 0;
        foreach ($products as $product) {
            if (empty($product['gift'])) {
                $total_product_discount += ((float)$product['product_price_original'] - (float)$product['product_final_price']) * (float)$product['quantity'];
            }
        }
    ...
    public function getAvailableFields()
    {
        return array(
            ...
            'order' => array(
                ...
                'id_order' => $this->i18n['idOrder'],
            ),
            'customer' => array(
                'customer_name' => $this->i18n['customer_name'],
                'customer_email' => $this->i18n['customer_email'],
            ...
            'summary' => array(
                ...
                'amount_received' => $this->i18n['amount_received'],
                'change_returned' => $this->i18n['change_returned'],
            ),
            'others' => array(
                'you_saved' => $this->i18n['you_saved'],
    ...
    )
    {
        ...
        foreach ($order_collections as $order) {
            ...
            if ((empty($exchange_products) && empty($return_products)) || $order->hasExchangeProducts($exchange_products)) {
            ...
            $payment = $order->getGivenAndReturnMoney();
            $payment = array_shift($payment);
            if ($is_return && $order->current_state == PosConfiguration::get('POS_DEFAULT_STANDARD_ORDER_STATE')) {
                $amount_received = (float)$payment['given_money'];
                $change_returned = (float)$payment['change'];
            } else {
                $amount_received += (float)$payment['given_money'];
                $change_returned += (float)$payment['change'];
            }
        ...
        $order = is_array($order_collections) ? $order_collections[0] : $order_collections->getFirst();
        if ($shipping_back) {
            $total_shipping_tax_incl = $order->total_shipping_tax_incl;
        }
        ...
        $vouchers = $this->getAvailableCartRules($order->id_customer);
        if (empty($this->context->customer)) {
            $this->context->customer = $customer;
        }
        $vouchers_used = $this->getCartRules();
        $tax_return_detail = array();
        ...
        $use_tax = Configuration::get('PS_TAX') && !Product::getTaxCalculationMethod((int)$order->id_customer);
//        foreach ($products as $product) {
//            if (isset($product['return']) && $product['return']) {
//                $total_tax_return -= $product['tax_amount'];
//            } else {
//                $total_tax_return += $product['tax_amount'];
//            }
//        }
        ...
        return array(
            ...
            'customer_name' => $customer->isDefaultCustomer($this->context->employee->id, $this->context->shop->id) ? null : implode(' ', array($customer->firstname, $customer->lastname)),
            'customer_email' => $customer->isDefaultCustomer($this->context->employee->id, $this->context->shop->id) ? null : $customer->email,
            'loyalty' => $customer->isDefaultCustomer($this->context->employee->id, $this->context->shop->id) ? '' : $this->i18n['loyalty'] . ': ' . Tools::displayPrice($loyalty['value'], $currency, false) . ' (' . $loyalty['points'] . ' ' . ($loyalty['points'] > 1 ? $this->i18n['points'] : $this->i18n['point']) . ')',
            ...
            'subtotal' => Tools::displayPrice($use_tax ? $total_products_wt - $total_order_gift_discount : $total_products - $total_order_gift_discount, $currency),
            'subtotal_with_discount' => Tools::displayPrice($use_tax ? $total_products_wt + $total_product_discount : $total_products + $total_product_discount, $currency),
            'use_tax' => $use_tax,
            ...
            'vouchers' => $vouchers,
            'return' => $is_return,
            'amount_received' => Tools::displayPrice($amount_received, $currency, false),
            'change_returned' => Tools::displayPrice($change_returned, $currency, false),
            'id_order' => $order->id,
        );
    }
            ...
            foreach ($products as &$product) {
                foreach ($product as $key => $value) {
                    ...
                    if ($key == 'product_name') {
                        ...
                        $product['name'] = PosProduct::getProductNames(
                            $product['product_id'],
                            $this->context->language->id
                        );
                        $product['tax_detail'] = PosTax::getProductTaxDetail($product['tax_calculator'], $product['total_price_tax_excl'], $product['product_quantity'], $this->context->language->id);
     ...
     *               )
     */
    public function getAvailableCartRules($id_customer = null)
    {
        $fields = array(
            'id_cart_rule',
            'name',
        ...
        $available_cart_rules = CartRule::getCustomerCartRules(
            $this->context->language->id,
            ($id_customer) ? $id_customer : (isset($this->context->customer->id) ? $this->context->customer->id : 0),
            true,
            true,
            true,
            $this->context->cart,
    ...
    {
        return array(
            'fullname' => isset($this->context->employee) ? implode(
                ' ',
                array($this->context->employee->firstname, $this->context->employee->lastname)
            ) : null,
        );
    }
    ...
    public function getReceiptPageSizes()
    {
        ...
        return array(
            array(
                'name' => $this->i18n['k80'],
                'value' => 'K80',
                'checked' => PosConfiguration::getValueByEmployeeId($id_employee, 'POS_RECEIPT_PAGE_SIZE') == 'K80',
            ),
            array(
                'name' => $this->i18n['k57'],
                'value' => 'K57',
                'checked' => PosConfiguration::getValueByEmployeeId($id_employee, 'POS_RECEIPT_PAGE_SIZE') == 'K57',
            ),
        );
    }
     ...
     *               )
     */
    public function getPosProfiles()
    {
     ...
     *               )
     */
    public function formatPersonalizeData($data, $id_employee = 0)
    {
        return array(
            $id_employee => $data,
        );
    ...
    /**
     * Get id employee depend on POS_PERSONAL_SETTING value.
     *
     * @return int
     */
    public function getIdEmployeeByPersonalSetting()
    {
        return Configuration::get('POS_PERSONAL_SETTING') ? (int)$this->context->employee->id : 0;
    }
     ...
     *
     */
    public function createLog($data, $idCart, $type)
    {
        $date = date('d-m-Y');
        $path_log = _PS_ROOT_DIR_ . '/modules/' . $this->name . '/log';
        if (!is_dir($path_log)) {
            $mkdir_log = $this->rmkdir($path_log);
        }

        $path = _PS_ROOT_DIR_ . '/modules/' . $this->name . '/log/' . $date;
        $file = $idCart . '_' . $type;

        if (is_dir($path)) {
            $logger = new FileLogger(0);
            $logger->setFilename(_PS_ROOT_DIR_ . '/modules/' . $this->name . '/log/' . $date . '/' . $file . '');
            $logger->log($data);
        } else {
            $mkdir = $this->rmkdir($path);
