...
class PosSpecificPrice extends SpecificPrice
{
     ...
     * @return bool
     */
    public static function getSpecificPriceType($id_product, $id_cart, $id_product_attribute = null)
    {
        $query = '
     ...
     * @return bool
     */
    public static function updateProductCombination(
        $id_cart,
        $id_product,
        $new_id_product_attribute,
        $old_id_product_attribute
    ) {
        $query = '
                UPDATE
                    `' . _DB_PREFIX_ . 'specific_price`
