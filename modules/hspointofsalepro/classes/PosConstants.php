...
class PosConstants
{
    ...
    const DEFAULT_DNI_NUMBER = '0000000000';
    ...
    const POS_PRICE_COMPUTE_PRECISION = 2;// for fixing the round up problem , make it more precisely and correct the amount due.
}
