 ...
 */
class PiwikAnalyticsAcquisitionController extends ModuleAdminController {
...
EOF;
                ...
                // https://demo.shoptech.media/analytics/index.php?module=Widgetize&action=iframe&disableLink=0&widget=1&moduleToWidgetize=Referrers&actionToWidgetize=getReferrerType&idSite=1&period=day&date=yesterday&disableLink=1&widget=1
                ...
                $this->content .= ''
                        ...
                        . '?module=Widgetize'
                        . '&action=iframe&disableLink=1&widget=1'
                        . '&moduleToWidgetize=Referrers'
                        . '&actionToWidgetize=getReferrerType'
                        . '&idSite=' . $PIWIK_SITEID
                        . '&period=' . $period
