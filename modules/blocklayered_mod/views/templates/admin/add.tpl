...
<fieldset>
	<legend><img src="{$uri}/img/cogs.gif" alt="{l s='Configuration' mod='blocklayered_mod'}" /> {l s='New filters template' mod='blocklayered_mod'}</legend>
	<form action="{$current_url}" method="post" class="form-horizontal" onsubmit="return checkForm();">
		...
		<table class="table-configurations">
			<tbody>
				<tr>
					<td class="label">{l s='Template name:' mod='blocklayered_mod'}</td>
					<td>
				...
				<tr>
					<td class="label">{l s='Categories used for this template:' mod='blocklayered_mod'}</td>
					<td>{$categories_tree}</td>
				</tr>
				{if isset($asso_shops)}
				<tr>
					<td class="label">
						{l s='Choose shop association:' mod='blocklayered_mod'}					
					</td>
					<td>{$asso_shops}</td>
				</tr>
				{/if}
				<tr>
					<td class="label">
						{l s='Filters:' mod='blocklayered_mod'}
						<p class="help-block">{l s='You can drag and drop filters to adjust position' mod='blocklayered_mod'}</p>
					</td>
					<td>
						<section class="filter_panel">
							<header>
								{l s='Total filters: %s'|sprintf:$total_filters mod='blocklayered_mod'} - {l s='Selected filters: <span id=\'selected_filters\'>%s</span>'|sprintf:0 mod='blocklayered_mod'}
							</header>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Sub-categories filter' mod='blocklayered_mod'}</td>
													<td>{l s='Filter result limit:' mod='blocklayered_mod'}</td>
													<td>
													...
													<td>{l s='Filter style:' mod='blocklayered_mod'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product stock filter' mod='blocklayered_mod'}</td>
													<td>{l s='Filter result limit:' mod='blocklayered_mod'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product condition filter' mod='blocklayered_mod'}</td>
													<td>{l s='Filter result limit:' mod='blocklayered_mod'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product manufacturer filter' mod='blocklayered_mod'}</td>
													<td>{l s='Filter result limit:' mod='blocklayered_mod'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product weight filter (slider)' mod='blocklayered_mod'}</td>
													<td>{l s='Filter result limit:' mod='blocklayered_mod'}</td>
													<td>
										...
										<table>
											<tbody>
												<tr>
													...
													<td class="filter-title">{l s='Product price filter (slider)' mod='blocklayered_mod'}</td>
													<td>{l s='Filter result limit:' mod='blocklayered_mod'}</td>
													<td>
...
<script type="text/javascript">
	...
	translations['selected_filters'] = '{l s='Selected filters: %s'|addslashes mod='blocklayered_mod'}';
</script>
