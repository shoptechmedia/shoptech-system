...
{/if}
<div class="panel">
	<h3><i class="icon-cogs"></i> {l s='Indexes and caches' mod='blocklayered_mod'}</h3>
	<div id="indexing-warning" class="alert alert-warning" style="display: none">
		{l s='Indexing is in progress. Please do not leave this page' mod='blocklayered_mod'}
	</div>
	<div class="row">
		<p>
			<a class="ajaxcall-recurcive btn btn-default" href="{$price_indexer_url}">{l s='Index all missing prices' mod='blocklayered_mod'}</a>
			<a class="ajaxcall-recurcive btn btn-default" href="{$full_price_indexer_url}">{l s='Rebuild entire price index' mod='blocklayered_mod'}</a>
			<a class="ajaxcall btn btn-default" id="attribute-indexer" rel="attribute" href="{$attribute_indexer_url}">{l s='Build attribute index' mod='blocklayered_mod'}</a>
			<a class="ajaxcall btn btn-default" id="url-indexer" rel="price" href="{$url_indexer_url}">{l s='Build URL index' mod='blocklayered_mod'}</a>
		</p>
	</div>
	<div class="row">
		<div class="alert alert-info">
			{l s='You can set a cron job that will rebuild price index using the following URL:' mod='blocklayered_mod'}
			<br />
			<strong>{$price_indexer_url}</strong>
			<br/>
			<br />
			{l s='You can set a cron job that will rebuild attribute index using the following URL:' mod='blocklayered_mod'}
			<br />
			<strong>{$attribute_indexer_url}</strong>
			<br/>
			<br />
			{l s='You can set a cron job that will rebuild URL index using the following URL:' mod='blocklayered_mod'}
			<br />
			<strong>{$url_indexer_url}</strong>			
		</div>
	</div>
	<div class="row">
		<div class="alert alert-info">{l s='A nightly rebuild is recommended.' mod='blocklayered_mod'}</div>
	</div>
</div>
<div class="panel">
	<h3><i class="icon-cogs"></i> {l s='Filters templates' mod='blocklayered_mod'}<span class="badge">{$filters_templates|count}</span></h3>
	{if $filters_templates|count > 0}
	<div class="row">
		<table class="table">
			<thead>
				<tr>
					<th class="fixed-width-xs center"><span class="title_box">{l s='ID' mod='blocklayered_mod'}</span></th>
					<th><span class="title_box text-left">{l s='Name' mod='blocklayered_mod'}</span></th>
					<th class="fixed-width-sm center"><span class="title_box">{l s='Categories' mod='blocklayered_mod'}</span></th>
					<th class="fixed-width-lg"><span class="title_box">{l s='Created on' mod='blocklayered_mod'}</span></th>
					<th class="fixed-width-sm"><span class="title_box text-right">{l s='Actions' mod='blocklayered_mod'}</span></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<div class="btn-group-action">
							<div class="btn-group pull-right">
								<a href="{$current_url}&amp;edit_filters_template=1&amp;id_layered_filter={(int)$template['id_layered_filter']}" class="btn btn-default">
									<i class="icon-pencil"></i> {l s='Edit' mod='blocklayered_mod'}
								</a> 
						...
						onclick="return confirm('{l s='Do you really want to delete this filter template' mod='blocklayered_mod'}');">
											<i class="icon-trash"></i> {l s='Delete' mod='blocklayered_mod'}
										</a>
									</li>
								</ul>
							</div>
	...
	{else}
		<div class="row alert alert-warning">{l s='No filter template found.' mod='blocklayered_mod'}</div>
	{/if}
	{if empty($limit_warning)}
	<div class="panel-footer">
		<a class="btn btn-default pull-right" href="{$current_url}&amp;add_new_filters_template=1"><i class="process-icon-plus"></i> {l s='Add new template' mod='blocklayered_mod'}</a>
	</div>
	{/if}
</div>
<div class="panel">
	<h3><i class="icon-cogs"></i> {l s='Configuration' mod='blocklayered_mod'}</h3>
	<form action="{$current_url}" method="post" class="form-horizontal">
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Hook layered navigation above product list' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
					<input type="radio" name="ps_layered_above" id="ps_layered_above_on" value="1"{if $above} checked="checked"{/if}>
					<label for="ps_layered_above_on" class="radioCheck">
						<i class="color_success"></i> {l s='Yes' mod='blocklayered_mod'}
					</label>
					<input type="radio" name="ps_layered_above" id="ps_layered_above_off" value="0"{if !$above} checked="checked"{/if}>
					<label for="ps_layered_above_off" class="radioCheck">
						<i class="color_danger"></i> {l s='No' mod='blocklayered_mod'}
					</label>
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Sticky(follow on scroll) if hooked to center column' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
					<input type="radio" name="ps_layered_sticky" id="ps_layered_sticky_on" value="1"{if $sticky} checked="checked"{/if}>
					<label for="ps_layered_sticky_on" class="radioCheck">
						<i class="color_success"></i> {l s='Yes' mod='blocklayered_mod'}
					</label>
					<input type="radio" name="ps_layered_sticky" id="ps_layered_sticky_off" value="0"{if !$sticky} checked="checked"{/if}>
					<label for="ps_layered_sticky_off" class="radioCheck">
						<i class="color_danger"></i> {l s='No' mod='blocklayered_mod'}
					</label>
					<a class="slide-button btn"></a>
				</span>
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Hide filter values when no product is matching' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Show the number of matching products' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Show products from subcategories' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Category filter depth (0 for no limits, 1 by default)' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Use tax to filter price' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Allow indexing robots (Google, Yahoo!, Bing, etc.) to use the Condition filter' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Allow indexing robots (Google, Yahoo!, Bing, etc.) to use the Availability filter' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Allow indexing robots (Google, Yahoo!, Bing, etc.) to use the Manufacturer filter' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label">{l s='Allow indexing robots (Google, Yahoo!, Bing, etc.) to use the Category filter' mod='blocklayered_mod'}</label>
			<div class="col-lg-9">
				<span class="switch prestashop-switch fixed-width-lg">
		...
		<div class="panel-footer">
			<button type="submit" class="btn btn-default pull-right" name="submitLayeredSettings"><i class="process-icon-save"></i> {l s='Save' mod='blocklayered_mod'}</button>
		</div>
	</form>
</div>
...
<script type="text/javascript">
	...
	translations['in_progress'] = '{l s='(in progress)' js=1 mod='blocklayered_mod'}';
	translations['url_indexation_finished'] = '{l s='URL indexing finished' js=1 mod='blocklayered_mod'}';
	translations['attribute_indexation_finished'] = '{l s='Attribute indexing finished' js=1 mod='blocklayered_mod'}';
	translations['url_indexation_failed'] = '{l s='URL indexing failed' js=1 mod='blocklayered_mod'}';
	translations['attribute_indexation_failed'] = '{l s='Attribute indexing failed' js=1 mod='blocklayered_mod'}';
	translations['price_indexation_finished'] = '{l s='Price indexing finished' js=1 mod='blocklayered_mod'}';
	translations['price_indexation_failed'] = '{l s='Price indexing failed' js=1 mod='blocklayered_mod'}';
	translations['price_indexation_in_progress'] = '{l s='(in progress, %s products price to index)' js=1 mod='blocklayered_mod'}';
	translations['loading'] = '{l s='Loading...' js=1 mod='blocklayered_mod'}';
	translations['delete_all_filters_templates'] = '{l s='You selected -All categories-: all existing filter templates will be deleted. Is it OK?' js=1 mod='blocklayered_mod'}';
	translations['no_selected_categories'] = '{l s='You must select at least one category' js=1 mod='blocklayered_mod'}';
</script>
