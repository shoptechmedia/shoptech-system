 ...
 *}
<li><a href="{$link->getModuleLink('customergroupregistration', 'mygroups', array(), true)|escape:'html':'UTF-8'}" title="{l s='My customer groups' mod='customergroupregistration'}"><i class="icon-user"></i><span>{l s='My groups' mod='customergroupregistration'}</span></a></li>
