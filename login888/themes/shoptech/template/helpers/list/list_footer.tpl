	...
	<div class="col-lg-6 mb-2">
		...
		<ul class="pagination pull-right">
			<li {if $page <= 1}class="disabled"{/if}>
				<a href="javascript:void(0);" class="btn btn-default pagination-link" data-page="1" data-list-id="{$list_id}">
					<i class="fa fa-angle-double-left"></i>
				</a>
			</li>
			<li {if $page <= 1}class="disabled"{/if}>
				<a href="javascript:void(0);" class="btn btn-default pagination-link" data-page="{$page - 1}" data-list-id="{$list_id}">
			...
			{while $p++ < $total_pages}
				...
				{else}
					<li {if $p == $page}class="active"{/if}>
						<a href="javascript:void(0);" class="btn btn-{if $p == $page}primary{else}default{/if} pagination-link" data-page="{$p}" data-list-id="{$list_id}">{$p}</a>
					</li>
				{/if}
			{/while}
			...
			<li {if $page >= $total_pages}class="disabled"{/if}>
				<a href="javascript:void(0);" class="btn btn-default pagination-link" data-page="{$total_pages}" data-list-id="{$list_id}">
