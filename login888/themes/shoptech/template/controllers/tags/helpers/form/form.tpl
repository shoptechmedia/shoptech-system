...
{if $key eq 'selects'}
<div class="card-body">
	<label class="control-label">{l s='Products:'}</label>

	<div class="row">
		<div class="col-lg-6">
			<select multiple id="select_left" class="form-control">
		...
		<div class="col-lg-6">
			<select multiple id="select_right" name="products[]" class="form-control">
