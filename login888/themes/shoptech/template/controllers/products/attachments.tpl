...
<div id="product-attachements" class="panel product-tab">
	...
	<h3 class="card-reader">{l s='Attachment'}</h3>
			...
			<div class="col-lg-9 col-lg-offset-3">
				<div class="row">
					<div class="col-lg-6">
						...
						<select class="form-control" multiple id="selectAttachment2">
							{foreach $attach2 as $attach}
								<option value="{$attach.id_attachment}">{$attach.name}</option>
							{/foreach}
						</select>
						<a href="#" id="addAttachment" class="btn btn-primary btn-block">
							{l s='Add'}
					...
					<div class="col-lg-6">
						...
						<select class="form-control" multiple id="selectAttachment1" name="attachments[]">
							{foreach $attach1 as $attach}
								<option value="{$attach.id_attachment}">{$attach.name}</option>
							{/foreach}
						</select>
						<a href="#" id="removeAttachment" class="btn btn-danger btn-block">
