...
<div id="product-suppliers" class="panel product-tab">
	...
	<h3 class="card-header">{l s='Suppliers of the current product'}</h3>
	...
	<div class="panel-body">
		...
		<label class="alert alert-info">{l s='Please choose the suppliers associated with this product. Please select a default supplier, as well.'}</label>
		<table class="table">
			<thead>
				<tr>
...
<br/><div class="panel">
	<h3 class="card-header">{l s='Supplier reference(s)'}</h3>
