...
<div id="product-customization" class="panel product-tab">
	...
	<h3 class="card-header">{l s='Add or modify customizable properties'}</h3>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-lg-1">
				<input class="form-control" type="text" name="uploadable_files" id="uploadable_files" value="{$uploadable_files|htmlentities}" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-1">
				<input class="form-control" type="text" name="text_fields" id="text_fields" value="{$text_fields|htmlentities}" />
			</div>
		</div>
		{if $has_file_labels}
		<hr/>
