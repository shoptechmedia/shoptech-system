...
<div id="product-associations" class="panel product-tab">
	...
	<h3 class="card-header">{l s='Associations'}</h3>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-lg-5">
				<select class="form-control" id="id_category_default" name="id_category_default">
			...
			<div class="col-lg-5">
				...
				<div id="ajax_choose_product">
					<div class="input-group">
						<input class="form-control" type="text" id="product_autocomplete_input" name="product_autocomplete_input" />
		...
		<div class="form-group">
			...
			<div class="col-lg-5">
				<select class="form-control" name="id_manufacturer" id="id_manufacturer">
