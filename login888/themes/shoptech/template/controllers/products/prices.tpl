...
<div id="product-prices" class="panel product-tab">
	...
	<h3 class="card-header">{l s='Product price'}</h3>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-lg-2">
				<div class="input-group">
					<span class="btn btn-info">{$currency->prefix}{$currency->suffix}</span>
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				...
				<div class="row">
					<div class="col-lg-6">
						<select class="form-control" onchange="javascript:calcPrice(); unitPriceWithTax('unit');" name="id_tax_rules_group" id="id_tax_rules_group" {if $tax_exclude_taxe_option}disabled="disabled"{/if} >
					...
					<div class="col-lg-2">
						<a class="btn btn-primary confirm_leave" href="{$link->getAdminLink('AdminTaxRulesGroup')|escape:'html':'UTF-8'}&amp;addtax_rules_group&amp;id_product={$product->id}"{if $tax_exclude_taxe_option} disabled="disabled"{/if}>
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
				<div class="input-group">
	                ...
	                />
					<span class="btn btn-info">{l s='per'}</span>
					<input class="form-control" id="unity" name="unity" type="text" value="{$product->unity|htmlentitiesUTF8}"  maxlength="255" onkeyup="if (isArrowKey(event)) return ;unitySecond();" onchange="unitySecond();"/>
				</div>
			</div>
		</div>
	...
	<div class="panel-footer">
		...
		<button type="submit" name="submitAddproduct" class="btn btn-primary pull-right" disabled="disabled"><i class="process-icon-loading"></i> {l s='Save'}</button>
		<button type="submit" name="submitAddproductAndStay" class="btn btn-primary pull-right" disabled="disabled"><i class="process-icon-loading"></i> {l s='Save and stay'}</button>
	</div>
</div>
{if isset($specificPriceModificationForm)}
<br/>
<div class="panel">
	<h3 class="card-header">{l s='Specific prices'}</h3>
		...
		<div class="col-lg-12">
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					{else}
						<div class="col-lg-3">
							<select class="form-control" name="sp_id_shop" id="sp_id_shop">
					...
					{/if}
						<div class="col-lg-3">
							<select class="form-control" name="sp_id_currency" id="spm_currency_0" onchange="changeCurrencySpecificPrice(0);">
						...
						<div class="col-lg-3">
							<select class="form-control" name="sp_id_country" id="sp_id_country">
						...
						<div class="col-lg-3">
							<select class="form-control" name="sp_id_group" id="sp_id_group">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					...
					<div class="input-group">
						<input class="form-control" type="text" name="customer" value="{l s='All customers'}" id="customer" autocomplete="off" />
						<span class="btn btn-info"><i id="customerLoader" class="icon-refresh icon-spin" style="display: none;"></i> <i class="icon-search"></i></span>
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<select class="form-control" id="sp_id_product_attribute" name="sp_id_product_attribute">
			...
			<div class="form-group">
				...
				<div class="col-lg-9">
					<div class="row">
						<div class="col-lg-4">
							<div class="input-group">
								<span class="btn btn-info">{l s='from'}</span>
								<input type="text" name="sp_from" class="datepicker" value="" style="text-align: center" id="sp_from" />
								<span class="btn btn-info"><i class="icon-calendar-empty"></i></span>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="input-group">
								<span class="btn btn-info">{l s='to'}</span>
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<div class="input-group">
						<span class="btn btn-info">{l s='unit'}</span>
						<input class="form-control" type="text" name="sp_from_quantity" id="sp_from_quantity" value="1" />
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<div class="row">
						<div class="col-lg-3">
							<input class="form-control" type="text" name="sp_reduction" id="sp_reduction" value="0.00"/>
						</div>
						<div class="col-lg-6">
							<select class="form-control" name="sp_reduction_type" id="sp_reduction_type">
								<option value="amount" selected="selected">{$currency->name|escape:'html':'UTF-8'}</option>
								<option value="percentage">{l s='%'}</option>
							</select>
						</div>
						<div class="col-lg-3">
							<select class="form-control" name="sp_reduction_tax" id="sp_reduction_tax">
