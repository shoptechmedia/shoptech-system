...
<div id="product-informations" class="panel product-tab">
	...
	<h3 class="card-header tab"><i class="icon-info"></i> {l s='Information'}</h3>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-lg-5">
				<input class="form-control" type="text" id="reference" name="reference" value="{$product->reference|htmlentitiesUTF8}" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3">
				<input class="form-control" maxlength="13" type="text" id="ean13" name="ean13" value="{$product->ean13|htmlentitiesUTF8}" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3">
				<input class="form-control" maxlength="12" type="text" id="upc" name="upc" value="{$product->upc|escape:'html':'UTF-8'}" />
			</div>
		</div>
