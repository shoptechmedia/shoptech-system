...
<div id="product-seo" class="panel product-tab">
	...
	<h3 class="card-header">{l s='SEO'}</h3>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-lg-2">
				<button type="button" class="btn btn-link" id="generate-friendly-url" onmousedown="updateFriendlyURLByName();"><i class="icon-random"></i> {l s='Generate'}</button>
			</div>
		</div>
		<div class="row">
