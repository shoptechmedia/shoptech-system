...
<div id="product-features" class="panel product-tab">
	...
	<h3 class="card-header">{l s='Assign features to this product'}</h3>
		...
		{foreach from=$available_features item=available_feature}
			...
			<tr>
				...
				{if sizeof($available_feature.featureValues)}
					<select class="form-control" id="feature_{$available_feature.id_feature}_value" name="feature_{$available_feature.id_feature}_value"
				...
				<div class="row lang-0" style='display: none;'>
					<div class="col-lg-9">
						<textarea class="form-control custom_{$available_feature.id_feature}_ALL textarea-autosize"	name="custom_{$available_feature.id_feature}_ALL"
				...
				{foreach from=$languages key=k item=language}
					...
					<div class="row translatable-field lang-{$language.id_lang}">
						...
						{/if}
						<textarea
								class="form-control custom_{$available_feature.id_feature}_{$language.id_lang} textarea-autosize"
