...
<div class="row">
	<div class="col-lg-6">
		<div class="panel">
			<div class="card-header">
				<h3 class="card-title"><i class="icon-user"></i> {l s='Customer Information'}</h3>
			</div>
	...
	<div class="col-lg-6">
		<div class="panel">
			<div class="card-header">
				<h3 class="card-title"><i class="icon-shopping-cart"></i> {l s='Order Information'}</h3>
			</div>
...
<div class="panel mt-4">
	<div class="card-header">
		<h3 class="card-title"><i class="icon-archive"></i> {l s='Cart Summary'}</h3>
	</div>
