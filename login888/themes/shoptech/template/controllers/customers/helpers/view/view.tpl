...
<ul class="breadcrumb cat_bar2">
	<li>
		<span><strong>{l s='Revenue'}:</strong> {$analytics->revenue}</span>
	</li>

	<li>
		<span><strong>{l s='Visits Converted'}:</strong> {$analytics->nb_visits_converted}</span>
	</li>

	<li>
		<span><strong>{l s='Revenue Subtotal'}:</strong> {$analytics->revenue_subtotal}</span>
	</li>

	<li>
		<span><strong>{l s='Revenue Tax'}:</strong> {$analytics->revenue_tax}</span>
	</li>

	<li>
		<span><strong>{l s='Revenue Shipping'}:</strong> {$analytics->revenue_shipping}</span>
	</li>

	<li>
		<span><strong>{l s='Revenue Discount'}:</strong> {$analytics->revenue_discount}</span>
	</li>

	<li>
		<span><strong>{l s='Items Bought'}:</strong> {$analytics->items}</span>
	</li>
</ul>
{/if}
...
<div id="container-customer">
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="panel clearfix">
				<div class="card-header">
					...
					<h3 class="card-title mr-1">
						...
						<span class="btn badge-info">{$customer->id|string_format:"%06d"}</span>
					</h3>

					<a href="mailto:{$customer->email}" class="btn badge-info ml-1">
						<i class="icon-envelope"></i>
						{$customer->email}
					</a>

					<div class="ml-auto">
						<a class="btn btn-primary" href="{$current|escape:'html':'UTF-8'}&amp;updatecustomer&amp;id_customer={$customer->id|intval}&amp;token={$token|escape:'html':'UTF-8'}&amp;back={$smarty.server.REQUEST_URI|urlencode}">
							{l s='Edit'}
						</a>
					</div>
				</div>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-file"></i> {l s='Orders'}</h3>
					<span class="badge badge-info ml-1">{count($orders)}</span>
				</div>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-shopping-cart"></i> {l s='Carts'}</h3>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-archive"></i> {l s='Purchased products'}</h3>
			...
			<div class="panel">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-eye"></i> {l s='Viewed products'}</h3>
					<span class="badge">{count($interested)}</span>
				</div>
		...
		<div class="col-lg-6">
			<div class="panel">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-eye-close"></i> {l s='Add a private note'}</h3>
				</div>

				<div class="alert alert-info">{l s='This note will be displayed to all employees but not to customers.'}</div>

				<form id="customer_note" class="card-body form-horizontal" action="ajax.php" method="post" onsubmit="saveCustomerNote({$customer->id|intval});return false;" >
					<div class="form-group">
						<div class="col-lg-12">
							<textarea class="form-control" name="note" id="noteContent" onkeyup="$('#submitCustomerNote').removeAttr('disabled');">{$customer_note}</textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-12">
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-envelope"></i> {l s='Messages'}</h3>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-ticket"></i> {l s='Vouchers'}</h3>
					<span class="badge">{count($discounts)}</span>
				</div>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-envelope"></i> {l s='Last emails'}</h3>
				</div>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-time"></i> {l s='Last connections'}</h3>
				</div>
			...
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-group"></i> {l s='Groups'}</h3>
					<span class="badge">{count($groups)}</span>

					<span class="ml-auto">
						<a class="btn btn-primary pull-right" href="{$current|escape:'html':'UTF-8'}&amp;updatecustomer&amp;id_customer={$customer->id|intval}&amp;token={$token|escape:'html':'UTF-8'}">
	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="panel">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-share-alt"></i> {l s='Referrers'}</h3>
				</div>
	...
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="panel mt-4">
				<div class="card-header">
					<h3 class="card-title"><i class="icon-map-marker"></i> {l s='Addresses'}</h3>
