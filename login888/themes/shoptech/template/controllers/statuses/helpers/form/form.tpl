	...
	<div class="col-lg-9">
		...
		{foreach $languages as $language}
			...
			<div class="input-group translatable-field lang-{$language.id_lang}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
				<select name="{$input.name}_{$language.id_lang}" class="form-control mr-1" 
				...
				<button type="button" class="btn btn-default dropdown-toggle mr-1" tabindex="-1" data-toggle="dropdown">
					{$language.iso_code}
