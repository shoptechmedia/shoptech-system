<div class="form-group">
	...
	<div class="col-lg-9">
		<div class="input-group col-lg-12">
			...
			<input type="text" id="customerFilter" class="form-control input-xlarge" name="customerFilter" value="{if $customerFilter}{$customerFilter|escape:'html':'UTF-8'}{elseif isset($smarty.post.customerFilter)}{$smarty.post.customerFilter|escape}{/if}" />
