<div class="form-group">
	...
	<div class="col-lg-8">
		...
		{/if}
					<input class="form-control" id="name_{$language.id_lang|intval}" type="text"  name="name_{$language.id_lang|intval}" value="{$currentTab->getFieldValue($currentObject, 'name', $language.id_lang|intval)|escape:'html':'UTF-8'}">
		{if $languages|count > 1}
...
<div class="form-group">
	...
	<div class="col-lg-8">
		<textarea name="description" rows="2" class="form-control textarea-autosize">{$currentTab->getFieldValue($currentObject, 'description')|escape}</textarea>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-lg-9">
		<div class="input-group">
			<input class="form-control" type="text" id="code" name="code" value="{$currentTab->getFieldValue($currentObject, 'code')|escape}" />
			<span class="input-group-btn">
				<a href="javascript:gencode(8);" class="btn btn-primary"><i class="icon-random"></i> {l s='Generate'}</a>
			</span>
		</div>
...
<div class="form-group">
	...
	<div class="col-lg-1">
		<input type="text" class="form-control input-mini" name="priority" value="{$currentTab->getFieldValue($currentObject, 'priority')|intval}" />
	</div>
</div>
