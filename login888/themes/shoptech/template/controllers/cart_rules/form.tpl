<div class="panel">
	<div class="card-header">
		<i class="icon-tag"></i>
		<h3 class="card-title">{l s='Cart rule'}</h3>
	</div>

	<div class="card-body">
		<ul class="tab nav nav-tabs">
			<li class="tab-row mr-1">
				<a class="btn btn-default tab-page" id="cart_rule_link_informations" href="javascript:displayCartRuleTab('informations');"><i class="icon-info"></i> {l s='Information'}</a>
			</li>
			<li class="tab-row mr-1">
				<a class="btn btn-default tab-page" id="cart_rule_link_conditions" href="javascript:displayCartRuleTab('conditions');"><i class="icon-random"></i> {l s='Conditions'}</a>
			</li>
			<li class="tab-row mr-1">
				<a class="btn btn-default tab-page" id="cart_rule_link_actions" href="javascript:displayCartRuleTab('actions');"><i class="icon-wrench"></i> {l s='Actions'}</a>
			</li>
		</ul>
	</div>

	<form action="{$currentIndex|escape}&amp;token={$currentToken|escape}&amp;addcart_rule" id="cart_rule_form" class="form-horizontal card-body" method="post">
		...
		<button type="submit" class="btn btn-default pull-right" name="submitAddcart_rule" id="{$table|escape}_form_submit_btn">
			{l s='Save'}
		</button>
