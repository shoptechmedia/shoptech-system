...
{block name="leadin"}
	<div id="CustomerThreadContacts" class="row mb-4">
		...
		<div class="col-lg-3">
			<div id="MeaningStatus" class="panel">
				<div class="card-header">
					<h3 class="card-title">{l s='Meaning of status'}</h3>
				</div>
				<ul class="list-group">
					<li class="list-group-item text-success"><i class="icon-circle"></i> {l s='Open'}</li>
					<li class="list-group-item text-danger"><i class="icon-circle"></i> {l s='Closed'}</li>
					<li class="list-group-item text-warning"><i class="icon-circle"></i> {l s='Pending 1'}</li>
					<li class="list-group-item text-warning"><i class="icon-circle"></i> {l s='Pending 2'}</li>
				</ul>
			</div>
		</div>
		<div class="col-lg-3">
