...
Tree.prototype =
  {
    ...
    init: function () {
      ...
      this.$element.find("label.tree-toggler, .fa-folder, .fa-folder-open").unbind('click');
      this.$element.find("label.tree-toggler, .fa-folder, .fa-folder-open").click(
        function () {
          if ($(this).parent().parent().children("ul.tree").is(":visible")) {
            $(this).parent().children(".fa-folder-open")
            ...
            $(this).parent().children(".fa-folder")
